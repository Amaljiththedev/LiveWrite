  ...
  return (
    <div className="max-w-md mt-44 w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-black">
      <h2 className="font-bold text-2xl text-neutral-200">
        Welcome to LiveWrite
      </h2>
      <p className="text-base max-w-md mt-3 mx-auto text-neutral-300">
      Step into the world of seamless writing. Log in to LiveWrite and bring your ideas to life, one word at a time.
      </p>
      ...
      <form className="my-8 text-white" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4 text-white">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="enter you name" type="text" />
          </LabelInputContainer>
